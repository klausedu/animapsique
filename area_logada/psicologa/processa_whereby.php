...
if (defined('WHEREBY_API_KEY') && WHEREBY_API_KEY != 'SUA_CHAVE_DE_API_AQUI') {
    try {
        ...
        if ($http_code >= 400) {
            // **MUDANÇA: Envia o erro detalhado de volta para o browser**
            $errorMessage = "O Whereby retornou um erro HTTP $http_code. Resposta do servidor: " . $result;
        ...
        if (isset($whereby_data['roomUrl'])) {
            ...
            throw new Exception("Resposta da API do Whereby inválida.");
        }
