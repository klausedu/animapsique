...
<head>
    ...
    <!-- O SCRIPT ALPINE.JS SERÁ CARREGADO NO RODAPÉ -->
    <style>
        :root {
        ...
        <nav x-data="{ open: false }" class="container mx-auto px-6 py-3">
            <div class="flex justify-between items-center">
                ...
                <div class="hidden md:flex items-center space-x-3">
                    ...
                    <a href="publicacoes.php" class="py-2 px-3 text-gray-700 hover:text-[var(--cor-primaria)]">Publicações</a>
                    <a href="contato.php" class="py-2 px-3 text-gray-700 hover:text-[var(--cor-primaria)]">Contato</a>
                    <!-- Botão atualizado para usar a nova cor -->
            ...
            <div x-show="open" @click.away="open = false" class="md:hidden mt-3">
                ...
                <a href="publicacoes.php" class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-200">Publicações</a>
